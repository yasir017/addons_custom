...
export class DomainSelectorIDFieldBits extends Component {
    setup(){
...
Object.assign(DomainSelectorIDFieldBits, {
    template: "advanced_web_domain_widget.DomainSelectorIDFieldBits",
    components: {
...
registry
    ...
    .add("id", DomainSelectorIDFieldBits)
